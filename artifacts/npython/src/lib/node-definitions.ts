...
export const NODE_DEFINITIONS: NodeDef[] = [
  ...
  },
  {
    type: "if_else",
    label: "If / Else If",
    description: "Cadeia if/elif/else — define _branch no pipeline",
    category: "logic",
    iconName: "GitBranch",
    color: "#a78bfa",
    defaultConfig: {
      ifExpression: "True",
      elifClauses: [] as Array<{ expression: string; branch: string }>,
      elseBranch: "else",
    },
    hasInput: true,
    hasOutput: true,
  },
  {
    type: "case",
    label: "Case / Match",
    description: "Compara variável com valores literais — define _switch_result",
    category: "logic",
    iconName: "LayoutList",
    color: "#e879f9",
    defaultConfig: {
